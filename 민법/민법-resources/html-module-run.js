(function(){
    ...
    function general_1(){
        $(`body`).append(`
            <script src="${s_}/html-module-어휘.js"></script>
            <script src="${s_}/html-module-대립.js"></script>
            <script src="${s_}/html-module-크기.js"></script>
            <script src="${s_}/html-module-포함.js"></script>
